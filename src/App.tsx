        ...
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 mb-6 font-mono">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-1.5 md:gap-2 w-full md:w-auto">
            ...
            >
              ...
              <span className={`text-[7.5px] md:text-[8px] uppercase font-bold tracking-wider mt-1 ${isDarkMode ? 'text-slate-500' : 'text-slate-400'}`}>Neutral Zone</span>
            </button>
          </div>
        </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="relative" ref={sectorRef}>
              ...
              >
                ...
                <span className={`text-xs font-black uppercase tracking-widest ${isDarkMode ? 'text-slate-300 group-hover:text-white' : 'text-slate-600 group-hover:text-indigo-600'}`}>
              ...
              {showSectorDropdown && (
                <div className={`absolute top-full left-0 mt-3 w-64 border rounded-xl shadow-2xl p-2 z-[100] backdrop-blur-xl max-h-80 overflow-y-auto transition-all ${isDarkMode ? 'bg-slate-900 border-white/10' : 'bg-white border-slate-200'}`}>
                  <div className={`px-3 py-1.5 mb-2 text-[8px] font-black uppercase tracking-widest border-b flex justify-between items-center ${isDarkMode ? 'text-slate-500 border-white/5' : 'text-slate-400 border-slate-100'}`}>
                    ...
                    <th className={`px-1 md:px-4 py-2.5 sticky left-0 backdrop-blur-md whitespace-nowrap w-[25%] font-mono transition-all duration-300 z-30 ${isDarkMode ? 'bg-slate-950/80 border-r border-white/10' : 'bg-white/80 border-r border-slate-200'}`}>
                      <div className="flex items-center gap-1 md:gap-3">
                        ...
                        <div className="flex-1 flex justify-center">
                          <span className={`text-[9px] md:text-[10px] font-bold uppercase tracking-tighter ${isDarkMode ? 'text-slate-400' : 'text-slate-500'}`}>Asset</span>
                        </div>
                      </div>
                    </th>
                    <th 
